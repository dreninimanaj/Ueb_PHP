...
<head>
    ...
    td {
        max-width: 260px; /* Adjust the maximum width as needed */
...
<body>
    ...
    <h3>Kadeti <span style="color: red;"><?php echo $selectedCadet; ?></span> &euml;sht&euml; vler&euml;suar gjithsejt <span style="color: blue;"><?php echo count($reviews); ?></span> her&euml;.</p></h3>
    <table>
        <tr>
            <th>Data dhe ora</th>
