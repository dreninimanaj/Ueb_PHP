...
?>
  ...
  <head>
    ...
    <title>Ankesat per zyrtaret e Policise se Nakama Roleplay</title>
    <style>
      body {
      ...
      .form-container button[type="submit"] {
        ...
        align-items: center;
        margin-top: 20px;
        /* Optional - adds some space between the last form element and the button */
      }
      ...
      <div class="form-container">
        <div class="logo-container">
          ...
          <div style="display: inline-block; margin-top: 45px;">
            <ul><b>&middot; Nakama Roleplay &middot;</b></ul>
          </div>
          <img style="height: 150px; width: auto; float: right; margin-left: 92px;" src="images/NAKAMAb.png" alt="Right Logo">
        </div>
        ...
        <h2>Ankohu p&euml;r zyrtar&euml;t e Policis&euml; s&euml; Nakama Roleplay</h2>
        ...
        <form method="post" action="ankohu-process.php">
          <div class="form-group">
            <label for="discord">Discordi juaj + Hashtag (origami#7770): <span class="required">*</span></label>
            <input type="text" id="discord" name="discord" required placeholder="Origamii#7770">
          </div>
          <div class="form-group">
